...
- The pipeline we will use will create html files for each reads file you have under the results folder. Open these html links by right clicking on them and choosing open with Live Server. 
...
Use the file called depth.csv and the script Plot Depth.ipynb for this purpose.
